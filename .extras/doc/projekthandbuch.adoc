...
."SchuhGetController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,SchuhGetController,svg]
----
include::SchuhGetController.plantuml[]
----
...
."SchuhWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,SchuhGetController,svg]
----
include::SchuhWriteController.plantuml[]
----
...
.SchuhQueryResolver für Lesezugriffe an der GraphQL-Schnittstelle
[plantuml,SchuhQueryResolver,svg]
----
include::SchuhQueryResolver.plantuml[]
----

Donec sollicitudin molestie malesuada. Praesent sapien massa, convallis a
pellentesque nec, egestas non nisi.

.SchuhMutationResolver für Schreibzugriffe an der GraphQL-Schnittstelle
[plantuml,SchuhMutationResolver,svg]
----
include::SchuhMutationResolver.plantuml[]
----
...
."SchuhReadService" von der Geschäftslogik
[plantuml,SchuhReadService,svg]
----
include::SchuhReadService.plantuml[]
----

Pellentesque in ipsum id orci porta dapibus. Donec rutrum congue leo eget
malesuada.

."SchuhWriteService" von der Geschäftslogik
[plantuml,SchuhWriteService,svg]
----
include::SchuhWriteService.plantuml[]
----
