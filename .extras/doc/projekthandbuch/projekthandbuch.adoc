...
."SchuhController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,SchuhController,svg]
----
include::SchuhController.plantuml[]
----
...
."SchuhService" von der Geschäftslogik
[plantuml,SchuhService,svg]
----
include::SchuhService.plantuml[]
----
