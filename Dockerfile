...
# Aufruf:   docker build --tag juergenzimmermann/schuh:2025.10.1-trixie .
#               ggf. --progress=plain
#               ggf. --no-cache
...
#           docker save juergenzimmermann/schuh:2025.10.1-trixie > schuh.tar
#           docker network ls
...
LABEL org.opencontainers.image.title="schuh" \
  org.opencontainers.image.description="Appserver schuh mit Basis-Image Debian Trixie" \
