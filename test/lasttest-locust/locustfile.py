...
class SchuhRequests(HttpUser):
    """Lasttest für HTTP-Requests fuer Server Schuh."""
    ...
    def get_id(self) -> None:
        """GET-Requests mit Pfadparameter: Schuh-ID."""
        id_list: Final = [1, 20, 30, 40, 50, 60]
        for schuh_id in id_list:
            self.client.get(f"/rest/{schuh_id}")

    @task(200)
    def get_titel(self) -> None:
        """GET-Requests mit Query-Parameter: Teilstring des Schuhtitels."""
