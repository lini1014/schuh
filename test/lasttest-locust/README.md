...
In der Datei `app.yml` im Verzeichnis `.extras\compose\schuh` werden bei der
...
Jetzt kann man die Docker-Container mit den Backend-Server und dem Schuh-Server
starten:

```powershell
    cd .extras\compose\schuh
    docker compose up
```
