...
describe('DELETE /rest', () => {
    ...
    test.concurrent('Vorhandenes Schuh loeschen', async () => {
        // given
    ...
    test.concurrent('Schuh loeschen, aber ohne Token', async () => {
        // given
        const url = `${restURL}/${id}`;
    ...
    test.concurrent('Schuh loeschen, aber mit falschem Token', async () => {
        // given
        const url = `${restURL}/${id}`;
        const headers = new Headers();
    ...
    test.concurrent('Vorhandenes Schuh als "user" loeschen', async () => {
        // given
