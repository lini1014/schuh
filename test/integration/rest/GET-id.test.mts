...
describe('GET /rest/:id', () => {
    test.concurrent.each(ids)('Schuh zu vorhandener ID %i', async (id) => {
        // given
    ...
    test.concurrent('Kein Schuh zu nicht-vorhandener ID', async () => {
        // given
    ...
    test.concurrent('Kein Schuh zu falscher ID', async () => {
        // given
