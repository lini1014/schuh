...
describe('GraphQL Mutations', () => {
    ...
    // -------------------------------------------------------------------------
    test('Schuh mit ungueltigen Werten neu anlegen', async () => {
        // given
        const mutation: GraphQLQuery = {
            query: `
                mutation {
    ...
    // -------------------------------------------------------------------------
    test('Schuh mit ungueltigen Werten aktualisieren', async () => {
        // given
        const id = '40';
        const mutation: GraphQLQuery = {
            query: `
    ...
    // -------------------------------------------------------------------------
    test('Nicht-vorhandenes Schuh aktualisieren', async () => {
        // given
        const id = '999999';
        const mutation: GraphQLQuery = {
            query: `
        ...
        expect(message).toBe(
            `Es gibt kein Schuh mit der ID ${id.toLowerCase()}.`,
        );
    ...
    // -------------------------------------------------------------------------
    test('Schuh loeschen als "user"', async () => {
        // given
        const mutation: GraphQLQuery = {
            query: `
                mutation {
